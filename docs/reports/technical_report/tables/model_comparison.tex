\begin{table}[hbt!]
\centering
\caption{Model Comparison Metrics (Overall Segment)}
\label{tab:model_comparison}
\begin{tabular}{@{} lllll @{}}
\toprule
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{WMAPE} & \textbf{Bias Ratio} \\
\midrule
...
CatBoost\_monthly\_minimal\_features & 55.48 & 97.88 & 0.4290 & -0.0036 \\
