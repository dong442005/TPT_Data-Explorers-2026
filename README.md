...
│   └── processed/              # [Không commit] Chứa file processed_data.json sinh ra sau khi chạy parse
│
...
3. Mở và chạy lần lượt 3 tệp SQL theo đúng thứ tự:
...
Mở Terminal của VS Code tại thư mục dự án và chạy lần lượt 2 lệnh sau:
```bash
# 1. Trích xuất và làm sạch dữ liệu hóa đơn mới tháng 3/2026
python src/extract_validate.py

# 2. Nạp dữ liệu tháng 3 đã làm sạch vào database PostgreSQL
python src/load_to_database.py
```
